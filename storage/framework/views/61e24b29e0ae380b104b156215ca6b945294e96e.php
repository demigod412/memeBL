    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800">
            ...
            <div class="p-6 border-b border-gray-100 dark:border-gray-800" x-data="{
                stats: {
                    total: <?php echo e(isset($t_history) ? $t_history->total() : 0); ?>,
                    wins: <?php echo e(isset($t_history) ? $t_history->where('type', 'WIN')->count() : 0); ?>,
                    losses: <?php echo e(isset($t_history) ? $t_history->where('type', 'LOSE')->count() : 0); ?>,
                    trades: <?php echo e(isset($t_history) ? $t_history->whereIn('type', ['Buy', 'Sell'])->count() : 0); ?>
                    ...
                    <?php if(isset($t_history) && $t_history->count() > 0): ?>
                        <?php $__currentLoopData = $t_history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="trading-item bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-100 dark:border-gray-700"
                                 x-show="$store.tradeFilter.value === 'all' || $store.tradeFilter.value === '<?php echo e($history->type); ?>'"
                                 x-transition>
                                ...
                                <div class="flex items-center justify-between">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                    <?php if($history->type == 'LOSE'): ?> bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400
                                                    <?php elseif($history->type == 'WIN'): ?> bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400
                                                    <?php elseif($history->type == 'Buy'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400
                                                    <?php else: ?> bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400 <?php endif; ?>">
                                                    <?php echo e($history->type); ?>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <?php endif; ?>
                                        <?php if($history->leverage): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                1:<?php echo e($history->leverage); ?>
                    ...
                    <div class="mt-8 px-6 py-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <span>Showing</span>
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($t_history->firstItem() ?? 0); ?></span>
                                <span>to</span>
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($t_history->lastItem() ?? 0); ?></span>
                                <span>of</span>
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($t_history->total()); ?></span>
                                <span>trades</span>
                            </div>
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($t_history->previousPageUrl()); ?>"
                                ...
                                <div class="flex items-center gap-1 mx-2">
                                    ...
                                    <?php if($start > 1): ?>
                                        <a href="<?php echo e($t_history->url(1)); ?>"
                                    ...
                                    <?php for($page = $start; $page <= $end; $page++): ?>
                                        <?php if($page == $t_history->currentPage()): ?>
                                            <div class="px-3 py-2 bg-blue-600 text-white rounded-lg shadow-md font-medium text-sm relative overflow-hidden">
                                                ...
                                                <span class="relative"><?php echo e($page); ?></span>
                                            </div>
                                        <?php else: ?>
                                            <a href="<?php echo e($t_history->url($page)); ?>"
                                               class="px-3 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white dark:hover:bg-gray-700 rounded-lg transition-all duration-200 text-sm font-medium">
                                                <?php echo e($page); ?>
                                    ...
                                    <?php if($end < $t_history->lastPage()): ?>
                                        <?php if($end < $t_history->lastPage() - 1): ?>
                                            <span class="px-2 text-gray-400 dark:text-gray-600 text-sm">...</span>
                                        <?php endif; ?>
                                        <a href="<?php echo e($t_history->url($t_history->lastPage())); ?>"
                                           class="px-3 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white dark:hover:bg-gray-700 rounded-lg transition-all duration-200 text-sm font-medium">
                                            <?php echo e($t_history->lastPage()); ?>
                                ...
                                <?php if($t_history->hasMorePages()): ?>
                                    <a href="<?php echo e($t_history->nextPageUrl()); ?>"
                                       class="px-3 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white dark:hover:bg-gray-700 rounded-lg transition-all duration-200 flex items-center gap-1 group">
                            ...
                            <div class="sm:hidden w-full">
                                <div class="flex items-center gap-2">
                                    ...
                                    <select onchange="window.location.href = this.value"
                                        ...
                                        <?php for($page = 1; $page <= $t_history->lastPage(); $page++): ?>
                                            <option value="<?php echo e($t_history->url($page)); ?>"
                                                    <?php echo e($page == $t_history->currentPage() ? 'selected' : ''); ?>>
                                                Page <?php echo e($page); ?> of <?php echo e($t_history->lastPage()); ?>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                                <div class="flex items-center gap-1">
                                    ...
                                    <span><?php echo e($t_history->perPage()); ?> items per page</span>
                                </div>
                                <div class="flex items-center gap-1">
                                    <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                                    <span>Page <?php echo e($t_history->currentPage()); ?> of <?php echo e($t_history->lastPage()); ?></span>
                                </div>
                                <?php if($t_history->hasMorePages()): ?>
                                    <div class="flex items-center gap-1">
                                        <div class="w-2 h-2 bg-amber-500 rounded-full animate-pulse"></div>
                                        <span><?php echo e($t_history->total() - $t_history->lastItem()); ?> more items</span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/user/thistory.blade.php ENDPATH**/ ?>