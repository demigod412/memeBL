    ...
    <?php if(Session::has('message')): ?>
        <div class="max-w-3xl mx-auto px-4">
            <div class="flex items-start p-4 rounded-xl bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100 shadow-md relative" role="alert">
                ...
                <div class="flex-1">
                    <p class="text-sm font-medium"><?php echo e(Session::get('message')); ?></p>
                </div>
...
<?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/components/danger-alert.blade.php ENDPATH**/ ?>