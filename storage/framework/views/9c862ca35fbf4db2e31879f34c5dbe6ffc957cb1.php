...
@media (max-width: 991px) {
    .hero.bg_img[data-background="<?php echo e(asset('public/images/hero-bg1.svg')); ?>"] {
        background-image: url('<?php echo e(asset("public/images/hero-mobile-bg.png")); ?>') !important;
                ...
                <div class="row mt-none-30 justify-content-center">
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-event">
                            ...
                            <div class="xb-item--holder">
                                <div class="xb-item--location"><i class="fal fa-map-marker-alt"></i><span>Virtual Event</span></div>
                                <h2 class="xb-item--title border_effect"><a href="#!">Advanced Algorithm Launch & Strategy Workshop</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-event">
                            ...
                            <div class="xb-item--holder">
                                <div class="xb-item--location"><i class="fal fa-map-marker-alt"></i><span>Virtual Event</span></div>
                                <h2 class="xb-item--title border_effect"><a href="#!">Q4 Market Analysis & Trading Strategy Summit</a></h2>
                                <div class="xb-item--date-time ul_li_between">
                                    <div class="xb-item--date xb-item--date-time1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.66663 1.66675V4.16675" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-event">
                            ...
                            <div class="xb-item--holder">
                                <div class="xb-item--location"><i class="fal fa-map-marker-alt"></i><span>Virtual Event</span></div>
                                <h2 class="xb-item--title border_effect"><a href="#!">Community Governance & Platform Roadmap Update</a></h2>
                                <div class="xb-item--date-time ul_li_between">
                                    <div class="xb-item--date xb-item--date-time1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.66663 1.66675V4.16675" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appx\resources\views/home/index.blade.php ENDPATH**/ ?>