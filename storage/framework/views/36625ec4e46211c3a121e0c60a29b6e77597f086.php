...
} elseif ($_instance->childHasBeenRendered('Rx68uMQ')) {
    $componentId = $_instance->getRenderedChildComponentId('Rx68uMQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('Rx68uMQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Rx68uMQ');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('Rx68uMQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appx\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>