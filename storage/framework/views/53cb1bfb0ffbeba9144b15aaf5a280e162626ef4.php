...
} elseif ($_instance->childHasBeenRendered('OjUEPIu')) {
    $componentId = $_instance->getRenderedChildComponentId('OjUEPIu');
    $componentTag = $_instance->getRenderedChildComponentTagName('OjUEPIu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OjUEPIu');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('OjUEPIu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\appx\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>