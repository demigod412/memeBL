...
} elseif ($_instance->childHasBeenRendered('Ia2br5i')) {
    $componentId = $_instance->getRenderedChildComponentId('Ia2br5i');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ia2br5i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ia2br5i');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('Ia2br5i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>