...
} elseif ($_instance->childHasBeenRendered('IeNweCZ')) {
    $componentId = $_instance->getRenderedChildComponentId('IeNweCZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('IeNweCZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IeNweCZ');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('IeNweCZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u731824248/domains/optimatraderpro.com/public_html/appx/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>