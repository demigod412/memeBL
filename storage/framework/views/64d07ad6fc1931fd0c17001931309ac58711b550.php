...
<style>
    ...
    <section class="section-spacing section-with-bg" id="what-is-bot-trading">
        <div class="section-bg" style="background-image: url('<?php echo e(asset("public/images/about1.jpg")); ?>');"></div>
        <div class="bg-overlay"></div>
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <div class="position-relative wow fadeInLeft">
                        <img src="<?php echo e(asset('public/images/bot1.png')); ?>" alt="Automated Bot Trading" class="img-fluid rounded-3">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/home/about.blade.php ENDPATH**/ ?>