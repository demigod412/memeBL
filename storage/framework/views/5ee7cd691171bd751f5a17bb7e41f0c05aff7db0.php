<div class="row">
    <div class="col-md-12">
        <form action="javascript:void(0)" method="POST" id="gatewayform">
            ...
            <small class="text-<?php echo e($text); ?>">Make sure to set in your paystack dashboard the Callback Url:
                <strong><?php echo e($settings->site_address); ?>/dashboard/paystackcallback</strong> </small>
            <div class="form-group">
                <h4 class="">Paystack Public Key</h4>
                <input type="text" name="paystack_public_key" class="form-control  "
                    value="<?php echo e($paystack->paystack_public_key); ?>">
            </div>
            <div class="form-group">
                <h4 class="">Paystack Secret Key</h4>
                <input type="text" name="paystack_secret_key" class="form-control  "
                    value="<?php echo e($paystack->paystack_secret_key); ?>">
            </div>
            <div class="form-group">
                <h4 class="">Paystack URL</h4>
                <input type="text" name="paystack_url" class="form-control  " value="<?php echo e($paystack->paystack_url); ?>"
                    readonly>
            </div>
            <div class="form-group">
                <h4 class="">Paystack Email</h4>
                <input type="text" name="paystack_email" class="form-control  "
                    value="<?php echo e($paystack->paystack_email); ?>">
            </div>
            <hr>
            ...
            <div class="form-group">
                ...
                <input type="text" name="bnc_api_key" class="form-control  "
                    value="<?php echo e($moresettings->bnc_api_key); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="bnc_secret_key" class="form-control  "
                    value="<?php echo e($moresettings->bnc_secret_key); ?>">
                <small class=""> from <a href="https://merchant.binance.com/en"
                        target="_blank">https://merchant.binance.com/en</a> </small>
            </div>
...
<?php /**PATH /home/u731824248/domains/optimatraderpro.com/public_html/appx/resources/views/admin/Settings/PaymentSettings/gateway.blade.php ENDPATH**/ ?>