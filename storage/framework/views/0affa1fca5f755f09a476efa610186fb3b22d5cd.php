            ...
            <ul class="space-y-1">
                <li>
                    <a href="<?php echo e(route('mplans')); ?>"
                       class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('mplans') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-medium' : ''); ?>">
                        <i data-lucide="target" class="w-5 h-5 mr-3"></i>
                        All Investment Plans
                    </a>
                </li>
                <!-- Investment Type Specific Plans -->
                <li class="ml-4">
                    <a href="<?php echo e(route('stocks')); ?>"
                       class="flex items-center px-3 py-2 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('stocks') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-medium' : ''); ?>">
                ...
                <li class="ml-4">
                    <a href="<?php echo e(route('crypto')); ?>"
                       class="flex items-center px-3 py-2 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('crypto') ? 'bg-orange-50 dark:bg-orange-900/50 text-orange-600 dark:text-orange-400 font-medium' : ''); ?>">
                        <i data-lucide="coins" class="w-4 h-4 mr-3"></i>
                        <span class="text-sm">Cryptocurrency</span>
                    </a>
                </li>
                <li class="ml-4">
                    <a href="<?php echo e(route('realestate')); ?>"
                       class="flex items-center px-3 py-2 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('realestate') ? 'bg-green-50 dark:bg-green-900/50 text-green-600 dark:text-green-400 font-medium' : ''); ?>">
...
<?php /**PATH /home/u731824248/domains/optimatraderpro.com/public_html/appx/resources/views/layouts/dasht.blade.php ENDPATH**/ ?>