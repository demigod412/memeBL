                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="annouc" value="on" class="selectgroup-input"
                                <?php echo e($settings->enable_annoc == 'on' ? 'checked' : ''); ?>>
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="withdraw" id="withdraw" value="true"
                                class="selectgroup-input" <?php echo e($settings->enable_with == 'true' ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">Enable</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="withdraw"
                                <?php echo e($settings->enable_with != 'true' ? 'checked' : ''); ?>value="false"
                                class="selectgroup-input">
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="googlet" id="googlet" value="on"
                                class="selectgroup-input" <?php echo e($settings->google_translate == 'on' ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">On</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="googlet"
                                <?php echo e($settings->google_translate != 'on' ? 'checked' : ''); ?> value="off"
                                class="selectgroup-input">
                            <span class="selectgroup-button">Off</span>
                        </label>
                    </div>
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="enable_kyc" value="yes" class="selectgroup-input"
                                <?php echo e($settings->enable_kyc == 'yes' ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">On</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="enable_kyc"
                                <?php echo e($settings->enable_kyc != 'yes' ? 'checked' : ''); ?> value="no"
                                class="selectgroup-input">
                            <span class="selectgroup-button">Off</span>
                        </label>
                    </div>
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="enable_kyc_registration" value="yes"
                                class="selectgroup-input"
                                <?php echo e($settings->enable_kyc_registration == 'yes' ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">On</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="enable_kyc_registration"
                                <?php echo e($settings->enable_kyc_registration != 'yes' ? 'checked' : ''); ?> value="no"
                                class="selectgroup-input">
                            <span class="selectgroup-button">Off</span>
                        </label>
                    </div>
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="return_capital" value="true" class="selectgroup-input"
                                <?php echo e($settings->return_capital ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">Yes</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="return_capital"
                                <?php echo e(!$settings->return_capital ? 'checked' : ''); ?> value="false"
                                class="selectgroup-input">
                    ...
                    <div class="selectgroup">
                        <label class="selectgroup-item">
                            <input type="radio" name="should_cancel_plan" value="1" class="selectgroup-input"
                                <?php echo e($settings->should_cancel_plan ? 'checked' : ''); ?>>
                            <span class="selectgroup-button">On</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="should_cancel_plan"
                                <?php echo e(!$settings->should_cancel_plan ? 'checked' : ''); ?> value="0"
                                class="selectgroup-input">
                            <span class="selectgroup-button">Off</span>
                        </label>
                    </div>
...
<?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/admin/Settings/AppSettings/webpreference.blade.php ENDPATH**/ ?>