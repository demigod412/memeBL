 ...
 <!-- Additional styles for events page -->
    ...
    <section class="events-section" id="events">
        <div class="container">
            ...
            <div class="row" id="events-container">
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-filter="featured conference">
                    <div class="event-card featured">
                        ...
                        <div class="event-content">
                            ...
                            <h3 class="event-title"><a href="/login">Global Blockchain Summit 2024</a></h3>
                            ...
                            <a href="/login" class="event-btn">Register Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.1s" data-filter="webinar">
                    <div class="event-card upcoming">
                        ...
                        <div class="event-content">
                            ...
                            <h3 class="event-title"><a href="/login">Meme Bull Tokenomics Deep Dive</a></h3>
                            ...
                            <a href="/login" class="event-btn">Join Webinar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.2s" data-filter="meetup">
                    <div class="event-card">
                        ...
                        <div class="event-content">
                            ...
                            <h3 class="event-title"><a href="/login">London Crypto Enthusiasts Gathering</a></h3>
                            ...
                            <a href="/login" class="event-btn">RSVP Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-filter="workshop">
                    <div class="event-card">
                        ...
                        <div class="event-content">
                            ...
                            <h3 class="event-title"><a href="/login">Building DApps on Meme Bull</a></h3>
                            ...
                            <a href="/login" class="event-btn">Book Seat</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.1s" data-filter="featured conference">
                    <div class="event-card featured">
                        ...
                        <div class="event-content">
                            <span class="event-category">Conference</span>
                            <h3 class="event-title"><a href="/login">Asia Blockchain Week 2024</a></h3>
                            ...
                            <a href="/login" class="event-btn">Get Tickets</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.2s" data-filter="webinar">
                    <div class="event-card">
                        ...
                        <div class="event-content">
                            ...
                            <h3 class="event-title"><a href="/login">Ask Me Anything with Meme Bull Team</a></h3>
                            ...
                            <a href="/login" class="event-btn">Set Reminder</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-5 wow fadeInUp">
                <a href="/login" class="register-btn">View All Events Calendar</a>
            </div>
        </div>
    </section>
    ...
    <section class="countdown-section">
        <div class="container">
            <div class="countdown-container">
                ...
                <a href="/login" class="register-btn wow fadeInUp" data-wow-delay="0.4s">Register Now for Early Bird Tickets</a>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8 mb-4 mb-lg-0 wow fadeInUp">
                    <div class="calendar-widget">
                        ...
                        <div class="event-highlight">
                            ...
                            <a href="/login" class="event-btn mt-3">Join Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="calendar-widget">
                        ...
                        <div class="text-center mt-4">
                            <a href="/login" class="event-btn" style="width: 100%;">Subscribe to Calendar</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="events-cta">
        <div class="container">
            ...
            <a href="/login" class="register-btn wow fadeInUp" data-wow-delay="0.4s">Become a Community Organizer</a>
        </div>
    </section>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/home/events.blade.php ENDPATH**/ ?>