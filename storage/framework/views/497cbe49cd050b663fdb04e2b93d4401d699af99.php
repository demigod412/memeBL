...
} elseif ($_instance->childHasBeenRendered('kNH5YGR')) {
    $componentId = $_instance->getRenderedChildComponentId('kNH5YGR');
    $componentTag = $_instance->getRenderedChildComponentTagName('kNH5YGR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kNH5YGR');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('kNH5YGR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/u731824248/domains/optimatraderpro.com/public_html/appx/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>