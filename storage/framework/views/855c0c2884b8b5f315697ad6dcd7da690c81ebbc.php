...
<?php $__env->startSection('title', 'Admin Login - Trading Platform'); ?>
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-900">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="trading-card rounded-2xl p-8 shadow-2xl">
            ...
            <?php endif; ?>
            <!-- Login Form -->
            <form method="POST" action="<?php echo e(route('adminlogin')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/auth/adminlogin.blade.php ENDPATH**/ ?>