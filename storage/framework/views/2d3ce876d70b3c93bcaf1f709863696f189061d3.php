...
<?php endif; ?>
        ...
        <div class="hidden sm:flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('user.bots.index')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-2 sm:py-3 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition text-sm sm:text-base">
                <i data-lucide="trending-up" class="w-4 h-4 sm:w-5 sm:h-5"></i>Subscribe to Bot
            </a>
        </div>
    </div>
        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-center justify-center sm:justify-start mb-2">
                <div class="inline-flex items-center px-3 py-1 text-sm rounded-lg bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 border border-orange-200 dark:border-orange-800">
                    ...
                    <!--    <span class="text-xs ml-1 opacity-75">(₿<?php echo e(number_format($bitcoin_price->price, 2, '.', ',')); ?>)</span>-->
                    <!--<?php endif; ?>-->
                </div>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/user/dashboard.blade.php ENDPATH**/ ?>