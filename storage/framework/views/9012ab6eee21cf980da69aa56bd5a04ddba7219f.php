                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-800 dark:text-white font-medium"><?php echo e(Auth::user()->name); ?></span>
                            </div>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-800 dark:text-white"><?php echo e(Auth::user()->email); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/user/support.blade.php ENDPATH**/ ?>