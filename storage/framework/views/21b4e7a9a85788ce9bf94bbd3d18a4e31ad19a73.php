                        ...
                        <div class="p-3 card ">
                            <form role="form" method="post" action="<?php echo e(route('updateplan')); ?>">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <h5 class="">Investment Type</h5>
                                        <select class="form-control" name="investment_type" required>
                                            <option value="">Select Investment Type</option>
                                            <option value="stock" <?php echo e((isset($plan->investment_type) && $plan->investment_type == 'stock') ? 'selected' : ''); ?>>Stock</option>
                                            <option value="crypto" <?php echo e((isset($plan->investment_type) && $plan->investment_type == 'crypto') ? 'selected' : ''); ?>>Crypto</option>
                                            <option value="real_estate" <?php echo e((isset($plan->investment_type) && $plan->investment_type == 'real_estate') ? 'selected' : ''); ?>>Real Estate</option>
                                        </select>
                                        <small class="">Select the type of investment this plan represents
                                          </small>
                                    </div>
                                    <div class="form-group col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u731824248/domains/optimatraderpro.com/public_html/appx/resources/views/admin/Plans/editplan.blade.php ENDPATH**/ ?>