                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($deposit->duser->name ?? "NA"); ?></td>
                                            <?php else: ?>
                                                    <td>User deleted.</td>
                                                <?php endif; ?>     
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('processwithdraw', $deposit->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u731824248/domains/optimatraderpro.com/public_html/appx/resources/views/admin/Withdrawals/mwithdrawals.blade.php ENDPATH**/ ?>