                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        <div>
                            ...
                            <h5 class="mb-2 text-white op-7">
                                <i class="fas fa-user-shield me-2"></i>Welcome back, <?php echo e(Auth('admin')->User()->firstName); ?> <?php echo e(Auth('admin')->User()->lastName); ?>!
                            </h5>
                            <p class="text-white op-5 mb-0">
                                <i class="far fa-clock me-1"></i><?php echo e(date('l, F j, Y')); ?> • <span id="current-time"></span>
                            </p>
                        </div>
                        <?php if(Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin'): ?>
                            <div class="py-2 ml-md-auto py-md-0">
                                <div class="btn-group" role="group">
                                    <a href="<?php echo e(route('mdeposits')); ?>" class="btn btn-success btn-lg shadow-sm">
                                        <i class="fas fa-arrow-down me-2"></i>Deposits
                                    </a>
                                    <a href="<?php echo e(route('mwithdrawals')); ?>" class="btn btn-danger btn-lg shadow-sm">
                                        <i class="fas fa-arrow-up me-2"></i>Withdrawals
                                    </a>
                                    <a href="<?php echo e(route('manageusers')); ?>" class="btn btn-info btn-lg shadow-sm">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h4 class="fw-bold mb-0 text-dark"><?php echo e(number_format($user_count)); ?></h4>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h4 class="fw-bold mb-0 text-dark"><?php echo e($activeusers); ?></h4>
                                        <small class="text-success">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h4 class="fw-bold mb-0 text-dark"><?php echo e($blockeusers); ?></h4>
                                        <small class="text-danger">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h4 class="fw-bold mb-0 text-dark"><?php echo e($plans); ?></h4>
                                        <small class="text-warning">
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: "Amount in <?php echo e($settings->currency); ?>",
                    data: [
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                return context.dataset.label + ': <?php echo e($settings->currency); ?>' +
                    ...
                    y: {
                        ...
                        ticks: {
                            ...
                            callback: function(value) {
                                return '<?php echo e($settings->currency); ?>' + new Intl.NumberFormat().format(value);
                            }
                        }
                    },
                    x: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>