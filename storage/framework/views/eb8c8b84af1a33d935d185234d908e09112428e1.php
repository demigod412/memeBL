            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                        <span id="searchResults"><?php echo e($experts->count()); ?> experts found</span>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/user/copy/experts.blade.php ENDPATH**/ ?>