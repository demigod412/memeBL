                            ...
                            <table id="ShipTable" class="table table-hover ">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <?php if(isset($deposit->duser->name) && $deposit->duser->name != null): ?>
                                            <td><?php echo e($deposit->duser->name ?? "N/A"); ?></td>

                                                <?php else: ?>
                                                    <td>User deleted.</td>
                                                <?php endif; ?>

                                                <?php if(isset($deposit->duser->email) && $deposit->duser->email != null): ?>
                                            <td><?php echo e($deposit->duser->email ?? "N/A"); ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('viewdepositimage', $deposit->id)); ?>"
                                                  ...
                                                  <i class="fa fa-edit"></i> <!-- Most recognized -->Edit
                                                </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u935933003/domains/stagingmemebull.randsender.space/public_html/resources/views/admin/Deposits/mdeposits.blade.php ENDPATH**/ ?>