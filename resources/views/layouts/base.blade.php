...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('public/images/favicon.png') }}" type="images/x-icon">
...
<div class="body_wrap">
    ...
    <div class="xb-header-menu" id="mobileMenu">
        <div class="xb-header-menu-scroll">
            ...
            <div class="xb-logo-mobile xb-hide-xl">
                <a href="/" rel="home"><img src="{{ asset('public/images/logo.png') }}" alt=""></a>
            </div>
    ...
    <!-- footer strt -->
    <footer class="footer bg_img pos-rel mt-110" data-background="{{ asset('public/images/footer-bg.png') }}">
        <div class="container">
            <div class="xb-contact">
                <div class="row g-0 mt-none-30">
                    <div class="col-lg-7 mt-30">
                        <div class="xb-inner bg_img" data-background="{{ asset('public/images/form_bg.png') }}">
                            <h2 class="xb-item--title">Ready to Start Automated Trading?</h2>
                            <form class="xb-item--form" action="#!">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="xb-item--field">
                                            <span><img src="{{ asset('public/images/contact-user.svg') }}" alt="Name"></span>
                                            <input type="text" placeholder="Full Name">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="xb-item--field">
                                            <span><img src="{{ asset('public/images/contact-email.svg') }}" alt="Email"></span>
                                            <input type="email" placeholder="Email Address">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="xb-item--field">
                                            <span><img src="{{ asset('public/images/contact-massage.svg') }}" alt="Message"></span>
                    ...
                    <div class="col-lg-5 mt-30">
                        <div class="testimonial-wrap bg_img" data-background="{{ asset('public/images/tm_bg.png') }}">
                                        ...
                                        <div class="xb-testimonial">
                                            <div class="xb-item--avater ul_li">
                                                <div class="xb-item--img">
                                                    <img src="{{ asset('public/images/testimonial.jpg') }}" alt="User Testimonial">
                                                </div>
                                                <div class="xb-item--holder">
                                                    <div class="xb-item--nationality ul_li">
                                                        <img src="{{ asset('public/images/tes-flag.png') }}" alt="USA Flag">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="xb-testimonial">
                                            <div class="xb-item--avater ul_li">
                                                ...
                                                <div class="xb-item--holder">
                                                    <div class="xb-item--nationality ul_li">
                                                        <img src="{{ asset('public/images/tes-flag.png') }}" alt="UK Flag">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="xb-testimonial">
                                            <div class="xb-item--avater ul_li">
                                                ...
                                                <div class="xb-item--holder">
                                                    <div class="xb-item--nationality ul_li">
                                                        <img src="{{ asset('public/images/tes-flag.png') }}" alt="Singapore Flag">
                                                        <span>Singapore</span>
                                                    </div>
                ...
                <div class="xb-footer-wrap ul_li_between">
                   ...
                   <div class="xb-item--footer_widget-community mb-30">
                        ...
                        <a class="them-btn" href="#!">
                            <span class="btn_icon">
                                <img src="{{ asset('public/images/discord-f-icon.svg') }}" alt="">
                            </span>
...
<script src="{{ asset('public/js/scrollspy.js') }}"></script>
<script src="{{ asset('public/js/countdown.js') }}"></script>
<script src="{{ asset('public/js/parallax-scroll.js') }}"></script>
