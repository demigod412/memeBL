    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <!-- Subheading -->
                <p class="lead mb-5" style="color: rgba(255, 255, 255, 0.85); font-size: 24px; line-height: 1.6;">
                    We're on a mission to democratize institutional-grade trading tools, making advanced algorithms accessible to everyone—from beginners to professionals.
                </p>
                ...
                <!-- Core Values -->
                <div class="mt-4">
                    <p class="text-white-50 mb-4" style="font-size: 18px;">Built on core principles of:</p>
...
<style>
    ...
    .them-btn.btn-outline:hover::before {
        opacity: 1;
    }
    ...
    <section class="section-spacing section-with-bg" id="what-is-bot-trading">
        <div class="section-bg" style="background-image: url('{{ asset("public/images/about1.jpg") }}');"></div>
        <div class="bg-overlay"></div>
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <div class="position-relative wow fadeInLeft">
                        <img src="{{ asset('public/images/bot1.png') }}" alt="Automated Bot Trading" class="img-fluid rounded-3">
    ...
    <section class="section-spacing section-with-bg" id="security">
        <div class="section-bg" style="background-image: url('{{ asset('public/images/bg-security.jpg') }}');"></div>
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <div class="wow fadeInRight">
                        <div class="xb-inner bg_img" data-background="{{ asset('public/images/form_bg.png') }}" style="min-height: 400px;">
            ...
            <div class="cta-section p-5 wow fadeInUp">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-center text-lg-end mt-4 mt-lg-0">
                        <a href="/register" class="them-btn btn-light" style="background: white; color: #080b18;">
    ...
    <section class="section-spacing section-with-bg" id="faq">
        <div class="section-bg" style="background-image: url('{{ asset('public/images/bg-faq.jpg') }}');"></div>
         <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8 text-center">
