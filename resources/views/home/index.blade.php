...
@section('content')
    ...
    <main>
        <!-- hero section start  -->
        <section class="hero bg_img pos-rel pt-120" data-background="{{ asset('public/images/hero-bg1.svg') }}">
            <div class="hero-shape">
                <div class="shape--1">
                    <img class="leftToRight" src="{{ asset('public/images/hero-sp_01.svg') }}" alt="">
                </div>
                <div class="shape--2">
                    <img class="topToBottom" src="{{ asset('public/images/hero-sp_02.svg') }}" alt="">
                </div>
                <div class="shape--3">
                    <img class="leftToRight" src="{{ asset('public/images/hero-sp_04.svg') }}" alt="">
                </div>
                <div class="shape--4">
                    <img class="topToBottom" src="{{ asset('public/images/hero-sp_03.svg') }}" alt="">
                </div>
                <div class="shape--5">
                    <img class="topToBottom" src="{{ asset('public/images/hero-sp_05.svg') }}" alt="">
                </div>
                <div class="shape--6">
                    <img class="leftToRight" src="{{ asset('public/images/hero-sp_06.svg') }}" alt="">
                </div>
            </div>
            <div class="container">
...
@media (max-width: 991px) {
    .hero.bg_img[data-background="{{ asset('public/images/hero-bg1.svg') }}"] {
        background-image: url('{{ asset("public/images/hero-mobile-bg5.jpg") }}') !important;
    ...
    By combining automation, intelligent trade execution, and strategic market scanning, Meme BULL enhances investors’ chances of capturing profitable market positions. The system aims to optimize entries and exits for better overall performance.
                            ...
                            <div class="hero-token">
                                ...
                                <div class="xb-item--accept">
                                    ...
                                    <ul class="xb-item--list ul_li">
                                        <li><img src="{{ asset('public/images/hero-icon01.svg') }}" alt="Bitcoin">Bitcoin</li>
                                        <li><img src="{{ asset('public/images/hero-icon02.svg') }}" alt="Ethereum">Ethereum</li>
                                        <li><img src="{{ asset('public/images/hero-icon03.svg') }}" alt="Solana">Solana</li>
                                        <li><img src="{{ asset('public/images/hero-icon04.svg') }}" alt="Meme Tokens">Meme Tokens</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <section class="partners z-3 pt-135">
            <div class="patners-title text-center">
                <span><img src="{{ asset('public/images/partner_07.png') }}" alt=""> Integrated Exchanges & Protocols <img src="{{ asset('public/images/partner_08.png') }}" alt=""></span>
            </div>
            <div class="partner-active partner-slider ul_li">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="xb-item--brand">
                            <div class="xb-item--brand_logo">
                                <img src="{{ asset('public/images/partner_01.png') }}" alt="Uniswap">
                            </div>
                            <span>Uniswap</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="xb-item--brand">
                            <div class="xb-item--brand_logo">
                                <img src="{{ asset('public/images/partner_02.png') }}" alt="Chainlink">
                            </div>
                            <span>Chainlink</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="xb-item--brand">
                            <div class="xb-item--brand_logo">
                                <img src="{{ asset('public/images/partner_03.png') }}" alt="Binance">
                            </div>
                            <span>Binance</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="xb-item--brand">
                            <div class="xb-item--brand_logo">
                                <img src="{{ asset('public/images/partner_04.png') }}" alt="DEX Aggregator">
                            </div>
                            <span>1inch</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="xb-item--brand">
                            <div class="xb-item--brand_logo">
                                <img src="{{ asset('public/images/partner_05.png') }}" alt="Ethereum">
                            </div>
                            <span>Ethereum</span>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="xb-item--brand">
                            <div class="xb-item--brand_logo">
                                <img src="{{ asset('public/images/partner_06.png') }}" alt="Solana">
                            </div>
                            <span>Solana</span>
                        </div>
                    </div>
        ...
        <section class="about pos-rel">
            ...
            <div class="about-img bg_img">
                <img class="wow fadeInRight" data-wow-duration=".7s" data-wow-delay="200ms" src="{{ asset('public/images/about-img.png') }}" alt="Meme BULL Trading Dashboard">
            </div>
        </section>
        <!-- about section end-->
            ...
            <div class="container pt-100">
                <div class="row justify-content-center mt-none-130">
                    <div class="col-xl-4 col-lg-6 process-col mt-130">
                        <div class="xb-process pos-rel">
                            <div class="xb-item--icon">
                                <img src="{{ asset('public/images/process_icon1.svg') }}" alt="Connect Wallet">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 process-col mt-130">
                        <div class="xb-process pos-rel">
                            <div class="xb-item--icon">
                                <img src="{{ asset('public/images/process_icon2.svg') }}" alt="Algorithm Setup">
                            </div>
                            <div class="xb-item--holder">
                    ...
                    <div class="col-xl-4 col-lg-6 process-col mt-130">
                        <div class="xb-process pos-rel">
                            <div class="xb-item--icon">
                                <img src="{{ asset('public/images/process_icon3.svg') }}" alt="Automated Trading">
                            </div>
                            <div class="xb-item--holder">
        ...
        <!-- token section start  -->
        <section id="chart" class="token z-1 mt-70 pt-150 pb-150 bg_img pos-rel" data-background="{{ asset('public/token-bg.png') }}">
            <div class="container">
            ...
            <div class="toke-shape">
                <div class="shape--one">
                    <img class="leftToRight" src="{{ asset('public/images/token.svg') }}" alt="">
                </div>
                <div class="shape--two">
                    <img class="topToBottom" src="{{ asset('public/images/token1.svg') }}" alt="">
                </div>
            </div>
        </section>
        <!-- token section end -->
        ...
        <section id="features" class="feature pos-rel pt-125 mb-170">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-wrap ul_li">
                            ...
                            <div class="xb-item--feature-icon">
                                <img src="{{ asset('public/images/fea-01.svg') }}" alt="Algorithmic Trading">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="feature-wrap ul_li">
                            ...
                            <div class="xb-item--feature-icon">
                                <img src="{{ asset('public/images/fea-02.svg') }}" alt="Market Analytics">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="feature-wrap ul_li">
                            ...
                            <div class="xb-item--feature-icon">
                                <img src="{{ asset('public/images/fea-03.svg') }}" alt="Risk Management">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="feature-wrap ul_li">
                            ...
                            <div class="xb-item--feature-icon">
                                <img src="{{ asset('public/images/fea-04.svg') }}" alt="Market Intelligence">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="feature-crypto bg_img" data-background="{{ asset('public/images/feature-bg.png') }}">
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-6">
                            <div class="cry-mobile-img">
                                <img src="{{ asset('public/images/fea-mobile.png') }}" alt="Mobile Trading Dashboard">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="feature-shape align-items-center">
                <img src="{{ asset('public/images/fea-color-sp.png') }}" alt="">
            </div>
        </section>
        <!-- feature section end -->
        ...
        <div class="faq__blockchain wow fadeInUp" data-wow-duration=".7s" data-wow-delay="200ms">
            ...
            <div class="team-shape">
                <div class="shape shape--1">
                    <img class="leftToRight" src="{{ asset('public/images/team-sp_01.svg') }}" alt="">
                </div>
                <div class="shape shape--2">
                    <img class="topToBottom" src="{{ asset('public/images/team-sp_02.svg') }}" alt="">
                </div>
                <div class="shape shape--3">
                    <img class="leftToRight" src="{{ asset('public/images/team-sp_03.svg') }}" alt="">
                </div>
                <div class="shape shape--4">
                    <img class="topToBottom" src="{{ asset('public/images/team-sp_04.svg') }}" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row mt-none-30 justify-content-center">
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-event">
                            <div class="xb-item--img">
                                <img src="{{ asset('public/images/event-img01.jpg') }}" alt="Algorithm Launch Event">
                            </div>
                            <div class="xb-item--holder">
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-event">
                            <div class="xb-item--img">
                                <img src="{{ asset('public/images/event-img02.jpg') }}" alt="Market Analysis Summit">
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--location"><i class="fas fa-map-marker-alt"></i><span>Virtual Event</span></div>
                    ...
                    <div class="col-lg-4 col-md-6 mt-30">
                        <div class="xb-event">
                            <div class="xb-item--img">
                                <img src="{{ asset('public/images/event-img03.jpg') }}" alt="Community Governance">
                            </div>
                            <div class="xb-item--holder">
                                <div class="xb-item--location"><i class="fas fa-map-marker-alt"></i><span>Virtual Event</span></div>
