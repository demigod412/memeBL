...
@endif
        ...
        <div class="hidden sm:flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            @endif
            <a href="{{ route('user.bots.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 sm:py-3 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition text-sm sm:text-base">
